...
//	
//	
//	  //NEL CASO DI UNA REQUEST CORRETTA E UN DTO CORRETTO
//    
//    ClienteDTOnoList dtoValido = new ClienteDTOnoList();
//    dtoValido.setUsername("NinoDangelo@gmail.com");
//    dtoValido.setNome("Nino");
//    dtoValido.setCognome("D'Angelo");
//    dtoValido.setIndirizzo("Via Posillipo 35");
//    
//    String dtoValidoJsonizzato = ClienteControllerUtilities.asJsonString(dtoValido);
//    
//    mock.perform(MockMvcRequestBuilders.post("/api/clienti")
//            .content(dtoValidoJsonizzato)
//            .contentType(MediaType.APPLICATION_JSON)
//            .accept(MediaType.APPLICATION_JSON))
//    .andExpect(status().isOk());
//    //.andExpect(MockMvcResultMatchers.content().json(dtoValidoJsonizzato));
//    Integer id = cRepo.findByUsername(dtoValido.getUsername()).getId();
//    cRepo.deleteById(id);
//    
//	
//	
